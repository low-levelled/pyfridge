...
| `exports/LFXS27566S_closed.step` / `_open.step` | The CAD deliverable — open in FreeCAD, Fusion 360, SolidWorks, Onshape, KiCad, etc. 108 parts (124 solids), mm units, Z up, origin at floor / cabinet centre / rear face. |
